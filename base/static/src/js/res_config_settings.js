...
let login_button_element = document.querySelector('button[type=submit]')
if (login_button_element && login_button_element.innerHTML == 'Log in') {
    console.log('-- jlo ndt & inspecting services')
}
